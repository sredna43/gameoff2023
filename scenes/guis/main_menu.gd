...
@onready var start_button: TextureButton = $Main/TitleAndButtons/CenterContainer/Buttons/StartContainer/Start
...
@onready var buttons = [start_button, controls_button, options_button]
var on_button = 0

enum screens {MAIN_MENU, CONTROLS_SCREEN}
